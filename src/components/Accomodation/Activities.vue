...
<div class="tab-pane">
    <div>
        ...
        <div class="row">
            <div class='season m-5 ' v-if="!activities || !activities.length">
                <p class='text-muted p-2'>No activities Registered Yet.</p>
            </div>
            <b-col v-for="(item, index) in activities" v-bind:key="item.id" md='3' class="m-4 user_card" style="background-color:#F5F9F7;">
                <b-row class="mb-2">
                    <b-col md='3' style="font-size: 2rem;">
                ...
                <b-row>
                    <b-col class="p-0">
                        <b-button block variant="outline-success" @click="editActivity(index)" style="height: 2em;">
                            <b-icon icon="pen"></b-icon>
                        </b-button>
                    </b-col>
                    <b-col class="p-0">
                        <b-button block variant="outline-danger" @click="deleteActivity(index)" style="height: 2em;">
    ...
    <div>
        ...
        <div class="row">
            <div class='season m-5 ' v-if="!facilities || !facilities.length">
                <p class='text-muted p-2'>No facilities Registered Yet.</p>
            </div>
            <b-col v-for="(item, index) in facilities" v-bind:key="item.id" md='3' class="m-4 user_card" style="background-color:#F5F9F7;">
                ...
                <b-row>
                    <b-col class="p-0">
                        <b-button block variant="outline-success" @click="editFacility(index)" style="height: 2em;">
                            <b-icon icon="pen"></b-icon>
                        </b-button>
                    </b-col>
                    <b-col class="p-0">
                        <b-button block variant="outline-danger" @click="deleteFacility(index)" style="height: 2em;">
                            <b-icon icon="trash"></b-icon>
                        </b-button>
                    </b-col>
                </b-row>
...
export default {
    ...
    methods: {
        addActivity() {
            ...
            this.$http.post('/lodges/' + this.$route.params.id + '/activities', {
                name: activity_name,
                cost_per_person: activity_price
            }).then(response => {
                ...
                const {
                    id,
                    name,
                    cost_per_person // eslint-disable-line
                } = response.data.data
        ...
        async editActivity(index) {
            const {
                ...
                name,
                cost_per_person // eslint-disable-line
            } = this.activities[index] // eslint-disable-line
            const {
                value: formValues
            ...
            if (formValues) {
                this.$http.patch('/lodges/' + this.$route.params.id + '/activities/' + id, {
                    name: formValues[0],
                    cost_per_person: formValues[1]
                }).then(response => {
                    ...
                    this.$set(this.activities, index, {
                        id: id,
                        name: name,
                        cost_per_person: cost_per_person
                    })
        ...
        addFacility() {
            ...
            this.$http.post('/lodges/' + this.$route.params.id + '/facilities', {
                name: facility_name,
                cost_per_person: facility_price
            }).then(response => {
                this.alertAddSuccess()
                this.name = ''
                const {
                    ...
                    name,
                    cost_per_person // eslint-disable-line
                } = response.data.data // eslint-disable-line
        ...
        async editFacility(index) {
            ...
            if (formValues) {
                this.$http.patch('/lodges/' + this.$route.params.id + '/facilities/' + id, {
                    name: formValues[0],
                    cost_per_person: formValues[1]
                }).then(response => {
                    this.toastSuccess('Successfully Updated')
                    ...
                    this.$set(this.facilities, index, {
                        id: id,
                        name: name,
                        cost_per_person: cost_per_person
                    })
