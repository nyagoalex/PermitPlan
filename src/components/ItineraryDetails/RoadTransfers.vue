            ...
            <div class="card-body">
                <b-row>
                    <b-col cols="1" class="pl-0 text-left">
                        <b-button variant="link" class="p-0" @click="addDayActivity('road transfer')" v-b-popover.hover.topright="'Add road transfer to day activity'">
                    ...
                    <b-col class="text-left">
                        ...
                        <label class="text-muted">{{transfer.starting_point}}
                            <b-icon icon="arrow-right" variant="primary" animation="cylon"></b-icon> {{transfer.destination}} <small><br>
                                {{transfer.vehicle.code}} - {{transfer.vehicle.type }} </small>
                        </label>
