        ...
        >
            ...
            <b-navbar-nav>
                ...
                <b-nav-item-dropdown text="+ More" right>
                    ...
                    <b-dropdown-item @click="$router.push({ name: 'Accommodations' })"
                        >Lodges + Hotels</b-dropdown-item
                    >
                    <b-dropdown-item @click="$router.push({ name: 'Transfers' })"
                        >Transfers</b-dropdown-item
                    >
                    <b-dropdown-divider></b-dropdown-divider>
                    <b-dropdown-item @click="$router.push({ name: 'Vehicles' })"
                        >Vehicles</b-dropdown-item
                    >
                    <b-dropdown-item @click="$router.push({ name: 'Guides' })"
                        >Guides & Drivers</b-dropdown-item
                    >
                    <b-dropdown-divider></b-dropdown-divider>
            ...
            <b-navbar-nav class="ml-auto">
                ...
                <b-nav-item-dropdown class="ml-4" right>
                    ...
                    >
                    <b-dropdown-item @click="$router.push({ name: 'Settings' })"
