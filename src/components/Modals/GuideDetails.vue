...
<template>
    <b-modal id="guide-details" size="xl">
        <template v-slot:modal-header="{ close }">
            <b-col>
                <h5 class="modal-title">Details for: {{ guide.first_name }} {{ guide.last_name }}<span class="guide-label"></span></h5>
            </b-col>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 pl-0 text-right">
                                            <b-button pill size="sm" variant="outline-success"
                                                ><small> {{ calculateAge(park.since) }} Yrs</small></b-button
                                            >
                                        </div>
                                        <div class="col-md-1 pl-0 text-right">
                                            <span style="cursor: pointer" v-b-tooltip.hover title="Edit Park Experience" @click="OpenEditPark(index, park)">
                                                <b-icon icon="pen"></b-icon>
                                            </span>
                                            <br />
                                            <span style="cursor: pointer" class="text-danger" v-b-tooltip.hover title="Remove Park Experience" @click="removePark(index)">
                            ...
                            <div class="pt-4">
                                <div class="season mb-3" v-for="(park, index) in guide.vehicle_types_experience" :key="park.name">
                                    <div class="row">
                                        ...
                                        <div class="col-md-1 pl-0 text-right">
                                            <span style="cursor: pointer" v-b-tooltip.hover title="Edit Park Experience" @click="OpenEditVehicle(index, park)">
                                                <b-icon icon="pen"></b-icon>
                                            </span>
                                            <br />
                                            <span style="cursor: pointer" class="text-danger" v-b-tooltip.hover title="Remove Park Experience" @click="removeVehicle(index)">
                                                <b-icon icon="trash"></b-icon>
                                            </span>
                                        </div>
                                    </div>
