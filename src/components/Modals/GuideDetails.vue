        ...
        <template v-slot:modal-header="{ close }">
            <b-col>
                <h5 class="modal-title">
                    Details for: {{ guide.first_name }} {{ guide.last_name
            ...
            <b-col class="status_dropdown">
                <b-dropdown
                    ...
                    v-if="guide.status == 'working'"
                >
                    <b-dropdown-item
                        variant="danger"
                        @click="guide.status = 'terminated'"
                    >
                        Terminated</b-dropdown-item
                    >
                    <b-dropdown-item
                        variant="warning"
                        @click="guide.status = 'probation'"
                    >
                        On Probation</b-dropdown-item
                    >
                </b-dropdown>
                ...
                <b-dropdown
                    ...
                    v-if="guide.status == 'terminated'"
                >
                    <b-dropdown-item variant="success" @click="guide.status = 'working'">
                        Working</b-dropdown-item
                    >
                    <b-dropdown-item
                        variant="warning"
                        @click="guide.status = 'probation'"
                ...
                <div class="row">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <ul
                                        ...
                                        v-if="errors.dob"
                                    >
                                        <li v-for="error in errors.dob" :key="error">
                                            {{ error }}
                                        </li>
                                    </ul>
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <input
                                        type="date"
                                        class="form-control"
                                        v-model="guide.experience_since"
                                        :class="{ 'is-invalid': errors.experience_since }"
                                    />
                                    <ul
                                        class="list-unstyled invalid-feedback"
                                        v-if="errors.experience_since"
                                    >
                                        <li
                                            v-for="error in errors.experience_since"
                                            :key="error"
                                        >
                                            {{ error }}
                                        </li>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <ul
                                        ...
                                        v-if="errors.phone"
                                    >
                                        <li v-for="error in errors.phone" :key="error">
                                            {{ error }}
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <select
                                        type="text"
                                        class="form-control"
                                        v-model="guide.contract_basis"
                                        :class="{ 'is-invalid': errors.contract_basis }"
                                    >
                                    ...
                                    <ul
                                        class="list-unstyled invalid-feedback"
                                        v-if="errors.contract_basis"
                                    >
                                        <li
                                            v-for="error in errors.contract_basis"
                                            :key="error"
                                        >
                                            {{ error }}
                                        </li>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input
                                        ...
                                        placeholder="300"
                                        class="form-control"
                                        v-model="guide.cost_per_day"
                                        :class="{ 'is-invalid': errors.cost_per_day }"
                                    />
                                    <ul
                                        class="list-unstyled invalid-feedback"
                                        v-if="errors.cost_per_day"
                                    >
                                        <li
                                            v-for="error in errors.cost_per_day"
                                            :key="error"
                                        >
                                            {{ error }}
                                        </li>
                    ...
                    <div class="col-md-4 col-12" style="border: 1px solid #e1ddd4">
                        <div class="col-md-12 col-12 pt-1">
                            ...
                            <hr />
                            <form>
                                <b-button variant="outline-success" @click="OpenAddPark">
                                    + Add a new Park</b-button
                                >
                            </form>
                            <div class="pt-5" v-if="guide.parks_experience.length == 0">
                                <strong>
                                    Tour Guide Has no Experience in parks click to
                                    Add</strong
                                >
                            </div>
                            <div class="pt-4">
                                <div
                                    class="season mb-3"
                                    v-for="(park, index) in guide.parks_experience"
                                    :key="park.name"
                                >
                                    <div class="row">
                                        ...
                                        <div class="col-md-1 pl-0 text-right">
                                            <span
                                                ...
                                                v-b-tooltip.hover
                                                title="Edit Park Experience"
                                                @click="OpenEditPark(index, park)"
                                            >
                    ...
                    <div class="col-md-4 col-12" style="border: 1px solid #e1ddd4">
                        <div class="col-md-12 col-12 pt-1">
                            ...
                            <form>
                                ...
                                >
                                    + Add a new vehicle Type</b-button
                                >
                                <div
                                    class="pt-5"
                                    v-if="guide.vehicle_types_experience.length == 0"
                                >
                                    <strong>
                                        Tour Guide Has no Experience in Vehicles click to
                                        Add</strong
                                    >
                                </div>
                            </form>
                            <div class="pt-4">
                                <div
                                    ...
                                    v-for="(
                                        park, index
                                    ) in guide.vehicle_types_experience"
                                    :key="park.name"
                                >
                                    <div class="row">
                                        <div class="col-md-8 pr-0">
                                        ...
                                        <div class="col-md-1 pl-0 text-right">
                                            <span
                                                ...
                                                v-b-tooltip.hover
                                                title="Edit Park Experience"
                                                @click="OpenEditVehicle(index, park)"
                                            >
                                                <b-icon icon="pen"></b-icon>
                                            </span>
                                            <br />
            ...
            <form @submit.stop.prevent>
                <div class="form-group">
                    ...
                    <input
                        ...
                        class="form-control"
                        placeholder="Name"
                        v-model="experience_form.name"
                        :class="{ 'is-invalid': !experience_form.name }"
                    />
                    <span class="invalid-feedback" v-if="!experience_form.name">
                ...
                <div class="form-group">
                    ...
                    <input
                        type="date"
                        class="form-control"
                        v-model="experience_form.since"
                        :class="{ 'is-invalid': !experience_form.since }"
                    />
                    <span class="invalid-feedback" v-if="!experience_form.since">
                        since field is required</span
                    >
                </div>
            </form>
            <template v-slot:modal-footer="{ cancel }">
...
export default {
    ...
    methods: {
        updateGuide() {
            ...
            this.errors = {}
            this.$http
                .patch('/guides/' + this.guide.id, this.guide)
                .then((response) => {
        ...
        updateVehicle() {
            this.$set(
                this.guide.vehicle_types_experience,
                this.edit_index,
