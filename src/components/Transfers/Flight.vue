...
<div class="bg-white text-left mt-3 mx-4">
    <b-table class="acc-tb" :striped="true" :outlined="true" :hover="true" :no-border-collapse="true" :items="transfers" :fields="fields" caption-top :sort-by.sync="sortBy" :sort-desc.sync="sortDesc" sort-icon-left responsive="sm" sticky-header @row-clicked="item=>$set(item, '_showDetails', !item._showDetails)">
            ...
            <b-row>
                ...
                <b-col>
                    <b-button @click="newTransferModal" class='float-right' size="sm" variant="success">
                        <b-icon icon="plus"></b-icon> Add Flight Transfer
                    </b-button>
                </b-col>
            </b-row>
        </template>
        ...
        <template v-slot:row-details="row">
            <b-row>
                ...
                <b-col class="text-right">
                    <b-button pill size="sm" variant="info" class="mr-4" v-b-modal.new-flight-transfer @click="transfer = row.item, mode = 'update'">
    ...
    <div>
        ...
        <b-pagination class="float-right" v-model="current_page" :total-rows="total" :per-page="per_page" last-number @input="getTransfers(current_page)"></b-pagination>
    </div>
