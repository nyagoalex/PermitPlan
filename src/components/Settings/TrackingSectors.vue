...
<b-container fluid="md">
    ...
    <b-button pill variant="outline-success" class="float-right" @click="newSectorModal">
        <b-icon icon="plus-circle"></b-icon> add sector
    </b-button>
    <br>
    <hr>
    <div class="row pl-3">
        <b-col v-for="sector in sectors" v-bind:key="sector.id" md='3' class="m-4 user_card" style="background-color:#F5F9F7;">
            ...
            <b-row>
                <b-col class="p-0">
                    <b-button block variant="outline-success" @click="editSectorModal(sector)" style="height: 2em;">
                        <b-icon icon="pen"></b-icon>
                    </b-button>
                </b-col>
                <b-col class="p-0">
                    <b-button block variant="outline-danger" @click="deleteSector(sector.id)" style="height: 2em;">
    ...
    <b-pagination align="right" pills v-model="current_page" :total-rows="total" :per-page="per_page" last-number @input="getSectors(current_page)"></b-pagination>
