...
<template>
    <div class="col-md-9  col-sm-12">
        <div class="">
            <div class="accordion-panel p-0 m-0 text-left">
                <div class="accordion p-0" id="details">
                    <div class="collapse-item">
                        <div class="row m-0">
                            <div class="col h-100">
                                <h4>Tour Itinerary</h4>
                                <p>2 Days | 2 Lodges | 4 Activities </p>
                            </div>
                            <div class="auto">
                                <span class="price">$560</span>
                                <a class="icon-btn uil uil-angle-down" data-toggle="collapse" data-target="#itinerary"></a>
                            </div>
                        </div>
                        <div class="collapse" id="itinerary" data-parent="#details">
                            itinerary
                            <div class="row">
                                <div class="col">
                                    <div class="tabs">
                                        <ul>
                                            <li data-toggle="tab" data-target="#day1">Day 1</li>
                                            <li data-toggle="tab" data-target="#day2">Day 2</li>
                                            <li data-toggle="tab" data-target="#day3">Day 3</li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-9">
                    ...
                    <div class="collapse-item">
                        <div class="row m-0">
                            ...
                            <div class="auto">
                                ...
                                <a class="icon-btn uil uil-angle-down" data-toggle="collapse" data-target="#permit"></a>
                            </div>
                        </div>
                        <div class="collapse" id="permit" data-parent="#details">
                            Permits
                        </div>
                    </div>
                    <div class="collapse-item">
                    ...
                    <div class="collapse-item">
                        <div class="row m-0">
                            <div class="col h-100">
                                <h4>Guides & Markup</h4>
                                <p>Solomon, Moses | <span class="text-success">+$700 Markup</span> </p>
                            </div>
                            <div class="auto">
        ...
        <div class="pl-3">
            ...
            <div class="container" v-infinite-scroll="getNotifications" infinite-scroll-disabled="notify_busy" infinite-scroll-distance="10" style="max-height: 450px; overflow-y: auto">
                <div v-for="(notification, index) in notifications" v-bind:key="index" :class="[
                        { read: notification.read, unread: !notification.read },
                        'card mb-2',
                        'hover-shadow-lg',
                        'notif-div'
                    ]" @click="markAsRead(index)" :id="`popover-1-${notification.id}`">
                    <div class="card-body d-flex align-items-center flex-wrap flex-lg-nowrap py-0">
                        <b-icon v-bind="mainProps" :icon="notification.read ? 'check' : 'exclamation'" variant="white" :class="{
                                'rounded-circle': true,
                        ...
                        <div class="col-lg-2 col-8 pl-0 pl-md-3 pt-3 pt-lg-0 text-left" style="
                                color: black;
                                font-size: 14px;
        ...
        <b-modal id="reschedule" :title="`Reschedule Permit: ${selected_permit.number}`">
            <div class="form-group">
                <input type="date" class="form-control place" v-model="selected_permit.tracking_date" :class="{ 'is-invalid': errors.tracking_date }" />
        ...
        <b-modal id="transfer-permit" :title="`Transfer Permit: ${selected_permit.number}`">
            <div class="form-group">
                Select Booking
                <model-select :options="this.toBookings" placeholder="select Booking" class="form-control" v-model="to_booking_id" :class="{ 'is-invalid': errors.to_booking_id }">
                </model-select>
        ...
        <b-modal id="transfered-permits-modal" title="Transfered Permits" size="xl" hide-footer>
            <b-table :items="booking.transfered_permits" :fields="transfered_permit_fields" :striped="true" :responsive="true" no-border-collapse sticky-header sort-icon-left>
                <template v-slot:cell(#)="data">
                    {{ data.index + 1 }}
                </template>
                ...
                <template v-slot:cell(payment_status)="row">
                    ...
                    <b-tooltip v-if="
                        ...
                        " :target="`tooltip-button-payment-status-${row.item.id}`" triggers="hover" variant="secondary">Expires on {{ row.item.expired_date }}</b-tooltip>
                </template>
            </b-table>
        </b-modal>
