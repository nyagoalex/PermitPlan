<template>
    <div class="p-5">
        <b-row class="py-2 font-weight-bold" style="background-color: #eee; font-size: 23px;">
            <b-col class="text-center"><span style="letter-spacing: 15px;">INVOICE </span> #{{booking.number.replace("B", "")}}</b-col>
        </b-row>
        <b-row class="mt-4">
        ...
        <b-row class="mt-4 mb-0 font-weight-bold" style="color:blue">
            ...
            <b-col class="text-right"> <small>Due: {{booking.arrival_date_readable}}</small></b-col>
        ...
        <b-row class="">
            ...
            <b-col cols="5">
                <p> Travel Date <br><span class="invoice_details"> {{booking.arrival_date_readable}} - {{booking.departure_date_readable}}</span></p>
                <p>Trip Duration <br> <span class="invoice_details">{{days}} Days | {{days-1}} Nights </span></p>
                <p>Activites <br> <span class="invoice_details">Swimming, gym</span></p>
            </b-col>
        ...
        <b-row class="mt-0">
            <b-col class="text-right" offset="8" style="border-top: 4px solid #eee;">
                <p><strong class="ml-5 float-left">Sub Total</strong> {{booking.total_cost}}</p>
                <p><strong class="ml-5 float-left">Amount Paid</strong> {{booking.total_paid}}</p>
                <p><strong class="ml-5 float-left">Balance</strong> {{booking.balance}}</p>
            </b-col>
        </b-row>
        <b-row class="mt-0">
