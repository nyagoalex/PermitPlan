        ...
        <div class="row">
          ...
          <div class="col-md-7 col-sm-12 text-center signup-form">
            ...
            <form @submit.prevent="handleSubmit" class="inner-form">
                ...
                <div class="form-group">
                    <button :disabled="loading || !checked" class="btn btn-success"  style="padding:10px 35px;font-size:20px;" @click="register"><b-icon icon="people-fill" ></b-icon> Create Account </button>
                </div>
      ...
      this.$http.post('api/register', this.form)
        .then(response => {
          this.$swal.fire({
            ...
            window.location = 'http://' + domain + '.' + process.env.VUE_APP_DOMAIN_PORT + '/login'
          })
        })
        .catch(errors => {
