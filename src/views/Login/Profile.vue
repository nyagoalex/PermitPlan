  ...
  <div class="container px-4 pt-4 ">
    <div class="row pt-5 bg-light">
      <div class="col-md-4 col-12 pt-5">
        ...
        <div class="row pt-4">
          <div
            class="col-md-3 col-4" style="border-radius:50%;height:110px;width:110px;"
          ><img alt="Vue logo" rounded="circle" src="@/assets/image/user-avatar.png" width="110px" height='110px'>
          </div>
              ...
              <div class="col-12">
                <hr class="mt-2 mb-3" />
                  ...
                  <b-overlay :show="loading" rounded opacity="0.6" spinner-small  class="d-inline-block">
                    <b-button class="btn btn-success" @click="updateProfile"><b-icon icon="pencil" ></b-icon> Update Details </b-button>
                    </b-overlay>
                </div>
              </div>
            </div>
