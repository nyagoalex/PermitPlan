...
<div class="bg-white text-left mt-3 mx-4">
    <b-table :striped="true" :outlined="true" :hover="true" :no-border-collapse="true" :items="items" :fields="fields" caption-top :sort-by.sync="sortBy" :sort-desc.sync="sortDesc" sort-icon-left responsive="sm" :per-page="perPage" :current-page="currentPage" sticky-header>
        <template v-slot:table-caption>
            <b-row>
                <b-col><span class='font-weight-bold'>Agents</span></b-col>
                <b-col class='text-center'>
                    <b-button v-b-modal.new-agent size="sm" variant="success">
        ...
        fakeBookings() {
            ...
            for (let i = 1; i < 20; i++) {
                const v = {
                    ...
                    no_of_booking: faker.random.number(),
